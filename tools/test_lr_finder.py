    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                print("✗ Should have raised ValueError for non-existent directory")
                return False
...
def test_checkpoint_discovery():
    ...
    try:
        ...
        print(f"✗ Checkpoint discovery failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_lr_loss_extraction():
    ...
    try:
        ...
        print(f"✗ LR/Loss extraction failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_schedule_type_detection():
    ...
    try:
        ...
        print(f"✗ Schedule detection failed: {e}")
        import traceback
        traceback.print_exc()
        return False
